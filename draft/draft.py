from draft.board import Board
from draft.picker import Picker
from draft.adp_list import ADPList
import click
import json
...
def single(Config):
        ...
        for x in board.cells:  
                x["picker"] = x["picker"].type

        # create a json object of the board to export
        meta = dict(year=Config.year,rounds=Config.rounds,pickers=Config.picker_types,draft_format=Config.draft_format)
